...
@property (nonatomic, strong) IMRoom * _Null_unspecified room;
- (void)viewDidLoad;
...
@property (nonatomic, readonly, copy) NSString * _Nonnull fetchID;
@property (nonatomic, readonly, copy) NSString * _Nonnull fetchName;
@property (nonatomic, readonly, copy) NSString * _Nonnull fetchData;
+ (NSString * _Nullable)primaryKey SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithValue:(id _Nonnull)value OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithRealm:(RLMRealm * _Nonnull)realm schema:(RLMObjectSchema * _Nonnull)schema OBJC_DESIGNATED_INITIALIZER;
